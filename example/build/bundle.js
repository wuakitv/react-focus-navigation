var ReactFocusNavigation = (function (exports,React,ReactDOM) {
  'use strict';
  ...
  var App = function (_React$Component2) {
    ...
    createClass(App, [{
      ...
      key: "onReceive",
      value: function onReceive(index) {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            HorizontalParent,
            { className: "horizontal-columns", withFocus: true },
            React.createElement(Item, null),
            React.createElement(Item, null)
          ),
          React.createElement(
